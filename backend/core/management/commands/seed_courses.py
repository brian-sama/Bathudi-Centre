        ...
        courses_data = [
            {
                ...
                'requirements': 'Certified ID copy, Grade 11/Matric certificate, Registration fee of R665.00',
            ...
            },
            {
                ...
                'requirements': 'Certified ID copy, Grade 10 certificate, Registration fee of R665.00',
            ...
            },
            {
                ...
                'requirements': 'Certified ID copy, Grade 9 certificate, Registration fee of R665.00',
        ...
        for course_data in courses_data:
            try:
                ...
                requirements = [
                    ...
                    {
                        'type': 'fee',
                        'description': f'Registration fee of R{course_data.get("registration_fee", 665.00)}',
                        'is_required': True,
                        'order': 3
                    }
                ]
