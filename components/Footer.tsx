        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12 pt-8 border-t border-white/5">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              ...
              <a 
                href="https://www.tiktok.com/discover/bathudi-automotive" 
                target="_blank" 
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-900 border border-white/10 flex items-center justify-center hover:bg-white/20 transition-colors"
              >
                <span className="sr-only">TikTok</span>
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.12v13.18a2.67 2.67 0 11-2.67-2.67c.26 0 .51.04.75.11V9.46a5.8 5.8 0 00-.75-.05A5.79 5.79 0 1015.82 15V8.33a7.9 7.9 0 004.63 1.49V6.69h-.86z"/>
                </svg>
              </a>
            </div>
          </div>
